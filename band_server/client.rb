...
response_list =  RestClient.get "#{address}list/datasets", :cookies => response_old.cookies
puts response_list
...
puts  RestClient.get "#{address}show_dataset/dataset_1", :cookies => response_old.cookies
...
puts  RestClient.get "#{address}list/classifiers", :cookies => response_old.cookies
